 ...
 * IDL can be found at `target/idl/exponent.idl.json`.
 */
  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        {
          name: 'depositor';
          docs: ['Permissionless depositor - not necessarily the owner of the YieldTokenPosition'];
          writable: true;
          signer: true;
        },
        {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: 'tokenAccount';
            docs: ['The token account for the emission where the vault authority is the authority'];
            type: 'pubkey';
          },
          {
            name: 'initialIndex';
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: 'tokenSyEscrow';
            docs: ['Pass-through token account for SY moving from the depositor to the SY program'];
            type: 'pubkey';
          },
          {
            name: 'tokenFeeTreasurySy';
